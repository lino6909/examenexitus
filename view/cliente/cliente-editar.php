<!--Formulario para agregar o editar un nuevo registro al presionar el boton de editar desde la datatable -->
...
<!--Se envia el formulario, los name dentro de los input con lo que se mandan para los registros  -->
<script>
